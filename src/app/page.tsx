      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          <div className="relative h-64 rounded-lg overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center">
              ...
              <button className="bg-tvt-primary text-white font-semibold py-2 px-4 rounded mt-4 hover:bg-tvt-accent">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-4">
                ...
                <button className="bg-tvt-secondary text-white font-semibold py-2 px-4 rounded mt-2 hover:bg-tvt-accent">
                  Reserve Now
                </button>
              </div>
            </div>
        ...
        <section>
          ...
          <div className="bg-gray-100 p-4 rounded-lg">
            ...
            <a href="#" className="text-tvt-primary hover:text-tvt-accent">Read More</a>
          </div>
        </section>
      </div>
  );
